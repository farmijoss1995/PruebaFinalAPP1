...
a persistence unit "EvaluacionWSArmijos1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSArmijos1\pom.xml":
...
artifact ("EvaluacionWSArmijos1.war") is already built. You can build
